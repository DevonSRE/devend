...
const Logos3 = ({
  ...
  return (
    <section className={cn(isHeader ? "py-64" : "py-4")}>
      {isHeader && (
        <div className="container flex flex-col items-center text-center">
          <h1 className="my-6 text-2xl font-bold text-pretty lg:text-4xl">{heading}</h1>
        </div>
      )}
      <div className={cn(isHeader && "pt-10 md:pt-16 lg:pt-20")}>
        <div className="relative mx-auto flex gap-5 items-center justify-center lg:max-w-5xl">
