        ...
        <div className='w-full max-w-4xl mx-auto px-4 md:px-6'>
          <div className='text-center mb-6 md:mb-10'>
            ...
            <div className='text-xs sm:text-sm text-gray-600 space-y-1'>
              ...
              {/*<div className='flex flex-col sm:flex-row justify-center gap-2 sm:gap-8'>
                ...
                <p>
                  Telephone:{' '}
                  <a href='tel:+2348068447200' className='font-medium hover:text-[#2e1a47]'>
                    +234 806 844 7200
                  </a>
                </p>
              </div>*/}
          ...
          <form onSubmit={handleSubmit} className='space-y-6 md:space-y-8'>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full sm:w-52 bg-brand hover:bg-brand-dark text-white text-sm sm:text-base px-8 py-3"
            >
              {isLoading ? (
