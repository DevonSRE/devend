...
const Home = () => {
  const services: ServiceItem[] = [
    { id: "01", name: "Event Management", link: "/services/event-management" },
    { id: "02", name: "Logistics Services", link: "/services/logistic" },
    { id: "03", name: "Catering Services", link: "/services/catering-service" },
  ]
    ...
    <div className="text-[#191919] geist-font">
      <div className="relative">
        <div className="w-full h-screen md:h-[85vh] lg:h-[90vh] relative">
          <Image src={heroImage} alt="Setting the Benchmark for Service Delivery" className="object-cover" fill sizes="100vw" priority />
        </div>

        <div className="absolute inset-0 bg-gradient-to-t from-white from-0% via-white/80 via-40% to-transparent to-70%" />
            ...
            <div className="w-full lg:w-96 bg-white/80 backdrop-blur-sm p-6 sm:p-8 rounded-lg animate-slideUp">
              ...
              <div className="space-y-4">
                {services.map((service) => (
                  <div key={service.id} className="border-b border-gray-200 pb-4 group">
                    <Link href={service.link} className="flex justify-between items-center group-hover:translate-x-1 transition-transform duration-300">
                      ...
                      <div className="text-gray-400 text-xl font-bold group-hover:text-black transition-colors duration-300">→</div>
                    </Link>
                  </div>
                ))}
              </div>
