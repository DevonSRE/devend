...
const Grid = () => {
  return (
    <div className="mt-20 overflow-x-hidden">
      {/* Row 1 */}
      <div className="flex flex-row bg-[#21143440]">
        <Image
          src={gridOne}
          alt=""
          className="flex-1 hover:opacity-100 transition duration-300"
        />
        <Image
          src={gridTwo}
          alt=""
      ...
      <div className="flex flex-row bg-[#21143440]">
        ...
        <div className="relative">
          <Image
            src={gridFive}
            alt=""
            className="h-full hover:opacity-100 transition duration-300"
          />
