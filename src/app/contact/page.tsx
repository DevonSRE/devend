...
export default function LogisticsForm() {
  ...
  const handleEventTypeChange = (id: string) => {
    setEventFormData((prev) => ({
      ...prev,
      eventTypes: { ...prev.eventTypes, [id]: !prev.eventTypes[id] },
    }));
  };
    ...
    <div className="w-full max-w-4xl mx-auto my-16 px-4">
      <div className="text-center mb-10">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8">
            ...
            <p>
              Telephone:{" "}
              <a href="tel:+2348034938139" className="font-medium">
          +2348034938139
              </a>
            </p>
          </div>
      ...
      <Tabs defaultValue="event" className="w-full mb-8">
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {eventFormData.date ? (
                        format(eventFormData.date as Date, "MM/dd/yy")
                      ) : (
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={eventFormData.date as Date | undefined}
        ...
        <TabsContent value="logistics">
          <div className="mt-6 text-center mb-8">
            <p className="max-w-2xl mx-auto">
              To provide you with cost estimate for your logistics needs, please
              fill out the form below and one of our team members will get back
              to you within 24 hours.
            </p>
          </div>
          <form
            onSubmit={(e) => handleSubmit(e, "logistics")}
            className="space-y-8"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                {logisticsTypes.map((type) => (
                  <div key={type.id} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      checked={
                        logisticsFormData.logisticsTypes[type.id] || false
                      }
                      onCheckedChange={() => handleLogisticsTypeChange(type.id)}
                    />
                    <Label
                      htmlFor={`logistics-${type.id}`}
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {logisticsFormData.fromDate ? (
                        format(logisticsFormData.fromDate as Date, "MM/dd/yy")
                      ) : (
                        <span className="text-muted-foreground">mm/dd/yy</span>
                      )}
                      <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={logisticsFormData.fromDate as Date | undefined}
                      onSelect={(date) =>
                        handleLogisticsDateChange("fromDate", date)
                      }
                      initialFocus
                    />
                  </PopoverContent>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className="w-full justify-start text-left font-normal"
                    >
                      {logisticsFormData.toDate ? (
                        format(logisticsFormData.toDate as Date, "MM/dd/yy")
                      ) : (
                        <span className="text-muted-foreground">mm/dd/yy</span>
                      )}
                      <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={logisticsFormData.toDate as Date | undefined}
                      onSelect={(date) =>
                        handleLogisticsDateChange("toDate", date)
                      }
                      initialFocus
                    />
                  </PopoverContent>
